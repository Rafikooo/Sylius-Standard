...
#[AutoconfigureTag('sylius.gateway_configuration_type', [
    'type' => 'stripe',
    'label' => 'app.form.gateway_configuration.stripe.label'
])]
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('publishable_key', TextType::class, [
                'label' => 'app.form.gateway_configuration.stripe.publishable_key',
            ])
            ->add('secret_key', TextType::class, [
                'label' => 'app.form.gateway_configuration.stripe.secret_key',
            ])
        ;
    }
}
